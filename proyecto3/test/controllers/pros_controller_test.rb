...
class ProsControllerTest < ActionController::TestCase
  ...
  test "should create pro" do
    assert_difference('Pro.count') do
      post :create, pro: { alumno_id: @pro.alumno_id, horas: @pro.horas, nombre_proy: @pro.nombre_proy }
    end
  ...
  test "should update pro" do
    patch :update, id: @pro, pro: { alumno_id: @pro.alumno_id, horas: @pro.horas, nombre_proy: @pro.nombre_proy }
    assert_redirected_to pro_path(assigns(:pro))
  end
